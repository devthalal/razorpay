...
-- CreateIndex
CREATE UNIQUE INDEX "subscriptions_planId_userId_key" ON "subscriptions"("planId", "userId");

-- CreateIndex
CREATE UNIQUE INDEX "subscription_invoices_serviceId_key" ON "subscription_invoices"("serviceId");

-- CreateIndex
CREATE UNIQUE INDEX "plans_serviceId_key" ON "plans"("serviceId");
